...
export const PipRaptorMascot: React.FC<MascotRenderProps> = ({
  ...
  return (
    <svg
      ...
      onClick={handleClick}
      viewBox="0 0 340 380"
      className={`w-68 h-80 sm:w-76 sm:h-88 will-change-transform origin-bottom cursor-pointer drop-shadow-2xl filter drop-shadow-[-2px_-2px_14px_rgba(74,222,128,0.25)] drop-shadow-[2px_2px_16px_rgba(168,85,247,0.25)] ${className}`}
    >
