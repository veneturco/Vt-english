...
export function getStoredKidsProgress(): KidsProgressState {
  try {
    ...
    if (saved) {
      ...
      return {
        ...
        unlockedWorlds: parsed.unlockedWorlds ?? ["dino_valley", "adventure_kingdom", "sky_castle"],
  ...
  return {
    ...
    unlockedWorlds: ["dino_valley", "adventure_kingdom", "sky_castle"],
...
class KidsAudioSFX {
  ...
  /**
   * 3. Soft, Non-Punitive Encouragement Tone for Retries
   */
  playErrorSoft() {
    playErrorSoft();
  }
